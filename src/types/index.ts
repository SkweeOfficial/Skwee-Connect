...
import type { OrderPayload, ProductMessagePayload } from "@/lib/commerce/types";
...
export type ContentType =
  ...
  | 'interactive'
  /** Customer sent their WhatsApp cart from our catalog product cards. */
  | 'order';
...
export interface Message {
   ...
   */
  interactive_payload?: InteractiveMessagePayload | ProductMessagePayload;
  /**
   * The cart lines of an inbound `order` message (customer sent their
   * WhatsApp cart). Only set when `content_type === 'order'`. Migration 040.
   */
