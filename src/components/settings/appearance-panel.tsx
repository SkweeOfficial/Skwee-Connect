...
/**
 * Appearance panel — light/dark mode toggle. The accent color is
 * SKWEE's fixed brand identity (set directly in globals.css), so
 * there's nothing to pick there — just mode.
 *
 * Applies + persists immediately. No save button: each change is a
 * single attribute swap on <html>, there's nothing to roll back.
 *
