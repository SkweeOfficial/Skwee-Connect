 ...
 *
 * The accent color is SKWEE's fixed brand identity (cocoa/caramel),
 * not user-selectable — see the single `:root` ACCENT block in
 * globals.css. There is no accent picker or `data-theme` attribute.
 */
