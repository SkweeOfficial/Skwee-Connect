...
// message.received for a WhatsApp cart order (content_type "order") also carries `order`:
// { …, "content_type": "order", "text": "🛒 Order: 3 items · INR 3,370",
//   "order": { "catalog_id": "…", "text": "Gift wrap please",
//              "items": [{ "retailer_id": "dress__4-5Y", "quantity": 2, "item_price": 1290, "currency": "INR", "name": "Party Dress (4-5Y)" }] } }
